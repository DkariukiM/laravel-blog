                  ...
                  <div class="mobile-clock-widget">
                    ...
                    <div>
                      <ul class="clock" id="clock">
                        <li class="hour" id="hour"> 10 </li>
                        <li class="min" id="min"> 30</li>
                        <li class="sec" id="sec"> AM </li>
                      </ul>
                      <div class="date f-24 mb-2" id="date"> 
                        <span id="monthDay"><script>document.write(new Date().getMonth())</script></span><span id="year"><script>document.write(new Date().getDay())</script>, <script>document.write(new Date().getFullYear())</script> </span></div>
                      <div>
                        <p class="m-0 f-14 text-light">Nairobi, Kenya</p>
                      </div>
                    </div>
                  </div>
                </div>
